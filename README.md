...
* **Autonomous Mobile Robots (UGV):** Path planning, Navigation, and Control.
* **Robot Operating System:** ROS & ROS2 (Humble/Foxy).
* **Computer Vision & AI:** Object Detection (YOLO v5/v8/v10), OpenCV.
* **SLAM & Mapping:** RTAB-Map, ORB-SLAM, Localization.
* **Embedded Systems:** Arduino, Raspberry Pi, NVIDIA Jetson, STM32.
* **Sensor Integration:** LiDAR, RGB-D Cameras (Kinect), IMU, GPS, Encoders.
...
* Deepen expertise in **Autonomous Navigation** and **SLAM** algorithms.
* Improve **Control Systems** modeling skills (MATLAB/Simulink).
* Contribute to impactful open-source robotics and AI projects.

---


<p align="center">
  <a href="[https://linkedin.com/in/YOUR_LINKEDIN_USERNAME](https://www.linkedin.com/in/%C3%B6mer-cihan-demir-687ab0255/)">
    <img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" />
  </a>
  <a href="mailto:o.cihandmr23@gmail.com">
